...
// Copyright (c) 2016 The BENJIROLLS developers
...
uint256 hashGenesisBlock("0x4deb54e42ec54fc20c975c3ab122cdd9655bc90d3c64c99d851300ae7dd629ae");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(537261531); // BENJIROLLS: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BENJIROLLS Signed Message:\n";
...
{
    // BENJIROLLS: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 177,602 blocks, which will occur approximately every 123 days
    nSubsidy >>= (nHeight / 177602); // BENJIROLLS: 177,602k blocks in ~123 days

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 360; // BENJIROLLS: 6 minutes
static const int64 nTargetSpacing = 60; // BENJIROLLS: 1 minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BENJIROLLS: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BENJIROLLS: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // BENJIROLLS: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x30be3f60eda0d41cae6cb172b584ec9d524156890bf5909e394679b651593ae2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Continental Congress decides to declare independence to America in 1776";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("516f399c302a61bf7244b024f736a7894304e4ea172dd9d57dd92331584f17ff4c70bb229788ba46126f0f73e11bbca6a9a7c62b4d9045a7face57a68c6ab69a90") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1470487742;
        block.nBits    = 537261531;
        block.nNonce   = 1371517350;

        if (fTestNet)
        {
            block.nTime    = 1470487742;
            block.nNonce   = 2144844363;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x9257ba93b0b94d9367a52c29ca455777ad5592d855658d1376a055b7176ea8b4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // BENJIROLLS: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BENJIROLLSMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BENJIROLLSMiner : ProcessBlock, block not accepted");
    }
